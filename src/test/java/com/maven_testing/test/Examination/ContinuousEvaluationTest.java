...
import com.maven_testing.page.Examination.ContinuousEvaluationPage;
import com.maven_testing.utility.Utility;

public class ContinuousEvaluationTest extends Base {
	
		
	ContinuousEvaluationPage cep;
	ExtentReports extent = new ExtentReports();
	ExtentSparkReporter spark = new ExtentSparkReporter("target/Spark.html");
	Utility util;

	public ContinuousEvaluationTest(){
		super();
	}
	...
	public void setUp() {
		...
		initialization();
		cep = new ContinuousEvaluationPage();
