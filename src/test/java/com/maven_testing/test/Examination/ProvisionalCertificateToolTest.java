...
import com.maven_testing.page.Examination.ProvisionalCertificateToolPage;
import com.maven_testing.utility.Utility;

public class ProvisionalCertificateToolTest extends Base {
	
		
	ProvisionalCertificateToolPage cep;
	ExtentReports extent = new ExtentReports();
	ExtentSparkReporter spark = new ExtentSparkReporter("target/Spark.html");
	Utility util;

	public ProvisionalCertificateToolTest(){
		super();
	}
	...
	public void setUp() {
		...
		initialization();
		cep = new ProvisionalCertificateToolPage();
	...
	public void getMenuPage() throws InterruptedException, IOException {
		...
		cep.clickMenu();
		cep.clickProvisionalCertificate();
