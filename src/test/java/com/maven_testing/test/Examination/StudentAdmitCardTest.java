...
import com.maven_testing.page.Examination.StudentAdmitCardPage;
import com.maven_testing.utility.Utility;

public class StudentAdmitCardTest extends Base {
	
		
	StudentAdmitCardPage eps;
	ExtentReports extent = new ExtentReports();
	ExtentSparkReporter spark = new ExtentSparkReporter("target/Spark.html");
	Utility util;

	public StudentAdmitCardTest(){
		super();
	}
	...
	public void examApplication() throws InterruptedException, IOException {
		...
		eps.addStudentAdmitCard();	
		
		test.pass("ADmit Card created successfully");
	}
//	@AfterTest
