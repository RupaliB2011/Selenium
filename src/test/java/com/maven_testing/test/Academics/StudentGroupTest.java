...
import com.maven_testing.Academics.StudentGroupPage;
...
import com.maven_testing.utility.Utility;
	...
	public class StudentGroupTest extends Base {
		...
		public void setUp() {
			...
			initialization();
			studentGroup = new StudentGroupPage();
		...
		public void getStudentGroupPage() throws InterruptedException, IOException {
			ExtentTest test=extent.createTest("getStudentGroupPage");
